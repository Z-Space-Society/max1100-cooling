...
| `max1100-card-adapter-v3.3dm` | Card adapter V3 | `cad/card_adapter.py` | V2 + scoop on the "Scoop" layer: PCB-side wall goes 10 deeper, angled 5 toward the PCB side. Separate solid; BooleanUnion with the tube to join. Draft |
